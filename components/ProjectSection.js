...
const projects = [
  ...
  },
  {
    ...
    repo: 'https://github.com/SamStrike98/Invoice-Generator',
    liveSite: ''
  },
  {
    id: 5,
    ...
    repo: 'https://github.com/SamStrike98/Weather',
    liveSite: ''
  },
  {
    id: 6,
    ...
    repo: 'https://github.com/SamStrike98/blog',
    liveSite: ''
  },
  {
    id: 7,
    ...
    repo: 'https://github.com/SamStrike98/Trainer-Experts',
    liveSite: ''
  },
  {
    id: 8,
    ...
    repo: 'https://github.com/SamStrike98/harmonford_estates',
    liveSite: 'https://harmonford-estates.vercel.app/'
  },
  {
    id: 9,
  ...
  return (
    <div className='flex flex-col lg:flex-row w-full items-center lg:items-start lg:justify-evenly flex-wrap gap-4'>
      {projects.map(project => (
        <ProjectCard key={project.id} title={project.title} image={project.image} description={project.description} id={project.id} techUsed={project.techUsed} repo={project.repo} liveSite={project.liveSite} />
      ))}
    </div>
  )
}
